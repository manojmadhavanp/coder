...
<div id="sidebarCollapsed" class="fixed top-0 left-0 z-40 h-full w-16 bg-gray-800 text-white shadow-xl flex flex-col justify-between">
  ...
  <div class="mb-4">
    <div class="flex flex-col items-center space-y-4">
      ...
      <!-- Settings -->
      <div class="relative group">
        <a href="settings.php" class="p-2 hover:bg-gray-700 rounded">
          <i data-lucide="settings" class="w-5 h-5"></i>
        </a>
        <div class="slideout absolute left-full top-0 ml-0 bg-gray-800 rounded shadow-lg min-w-[150px] px-2 py-1 whitespace-nowrap">
          Settings
      ...
      <!-- Logout -->
      <div class="relative group">
        <button onclick="logout()" class="p-2 hover:bg-gray-700 rounded focus:outline-none">
          <i data-lucide="log-out" class="w-5 h-5"></i>
        </button>
        <div class="slideout absolute left-full top-0 ml-0 bg-gray-800 rounded shadow-lg min-w-[150px] px-2 py-1 whitespace-nowrap">
          Logout
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                  <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Order ID</th>
                  <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Customer</th>
                  <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Amount</th>
              ...
              <tbody class="bg-white dark:bg-darkCard divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
                  ...
                  <td class="px-4 py-2 text-sm">$120.00</td>
                  <td class="px-4 py-2 text-sm">
                    <span class="px-2 py-1 rounded bg-green-200 text-green-800 dark:bg-green-800 dark:text-green-200">Completed</span>
                  </td>
                </tr>
                <!-- Additional rows -->
              </tbody>
